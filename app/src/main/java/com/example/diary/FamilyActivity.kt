...
import com.example.diary.databinding.ActivityFamilyBinding
import com.google.android.material.navigation.NavigationView

class FamilyActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    private var mBinding: ActivityFamilyBinding? = null
    private val binding get() = mBinding!!

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mBinding = ActivityFamilyBinding.inflate(layoutInflater)
