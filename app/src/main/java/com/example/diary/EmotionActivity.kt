...
import com.example.diary.databinding.ActivityEmotionBinding
import com.google.android.material.navigation.NavigationView

class EmotionActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    private var mBinding: ActivityEmotionBinding? = null
    private val binding get() = mBinding!!

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mBinding = ActivityEmotionBinding.inflate(layoutInflater)
