...
import com.example.diary.databinding.ActivityLearningBinding
import com.google.android.material.navigation.NavigationView

class LearningActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    private var mBinding: ActivityLearningBinding? = null
    private val binding get() = mBinding!!

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mBinding = ActivityLearningBinding.inflate(layoutInflater)
