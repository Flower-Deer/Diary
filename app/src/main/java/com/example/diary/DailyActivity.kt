...
import com.example.diary.databinding.ActivityDailyBinding
import com.google.android.material.navigation.NavigationView

class DailyActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    private var mBinding: ActivityDailyBinding? = null
    private val binding get() = mBinding!!

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        mBinding = ActivityDailyBinding.inflate(layoutInflater)
